...
const lugares = [
	...
	descricao: 'Lorem ipsum dolor sit amet consectetur adipisicing elit.Quaerat harum odio omnis est fugit, incidunt, magni corporis vero aperiam fugafacere ab delectus natus placeat dolor nam quos sint impedit!'
	},
	{
	id: '2',
	titulo: 'Praça H',
...
export async function getStaticProps() {
	// Aqui é obtido os dados de uma base de dados, por exemplo
	return {
		props: {
			lugares: lugares
		}
